...
class VocosCosyvoiceExp(VocosExp):
    ...
    def validation_step(self, batch, batch_idx, **kwargs):
        audio_input, speech_token_input, speaker_embedding_input = batch
        audio_hat = self(audio_input, speech_token=speech_token_input,
                         speaker_embedding=speaker_embedding_input, **kwargs)
